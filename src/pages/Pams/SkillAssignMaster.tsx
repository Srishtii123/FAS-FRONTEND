...
import AddSkillAssignForm from './AddSkillAssignForm';


const SkillAssignMasterPage = () => {
  //-------------- State ----------
...
const { data: kpiData, refetch: refetchDeptKpiData } = useQuery({
  ...
  queryFn: async () => {
    ...
    console.log("Skill Assign Response:", response);
  ...
  return (
    <div className="flex flex-col space-y-2">
      <Breadcrumbs aria-label="breadcrumb" sx={{ mb: 2, mt: 1 }}>
        ...
        <Typography color="text.primary">Skill_Assign</Typography>
      </Breadcrumbs>
...
export default SkillAssignMasterPage;
